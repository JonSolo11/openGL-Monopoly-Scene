...
public:
    ...
    {
        // Define minimum and maximum speed limits
        const float minSpeed = 0.5f;
        const float maxSpeed = 10.0f;

        // Adjust speed based on scroll input
        MovementSpeed += yoffset * 0.5f; // You can change 0.1f to scale the sensitivity of speed adjustment

        // Clamp the speed within the min and max limits
